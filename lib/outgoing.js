...
Outgoing.prototype.reqCompletedOrders = function (apiOnly = false) {
  this._send(C.OUTGOING.REQ_COMPLETED_ORDERS, apiOnly);
}
...
Outgoing.prototype.reqHistoricalNews = function (requestId, conId, providerCodes, startDateTime , endDateTime, totalResults, historicalNewsOptions = null) {
  this._send(C.OUTGOING.REQ_HISTORICAL_NEWS, requestId, conId, providerCodes, startDateTime , endDateTime , totalResults, historicalNewsOptions);
}

Outgoing.prototype.reqNewsArticle = function (requestId, providerCode, articleId, newsArticleOptions = null ) {
  this._send(C.OUTGOING.REQ_NEWS_ARTICLE, requestId, providerCode, articleId , newsArticleOptions);
}

Outgoing.prototype.reqMktDepthExchanges = function () {
  this._send(C.OUTGOING.REQ_MKT_DEPTH_EXCHANGES);
}

Outgoing.prototype.reqMatchingSymbols = function (requestId, pattern) {
  this._send(C.OUTGOING.REQ_MATCHING_SYMBOLS, requestId, pattern);
}
