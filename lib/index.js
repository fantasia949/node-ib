...
IB.prototype.reqCompletedOrders = function(apiOnly){
  this._send('reqCompletedOrders', apiOnly);
...
IB.prototype.reqHistoricalNews = function(requestId, conId, providerCodes, startDateTime, endDateTime, totalResults){
  this._send('reqHistoricalNews',requestId, conId, providerCodes, startDateTime , endDateTime , totalResults);
};

IB.prototype.reqNewsArticle = function(requestId, providerCode, articleId, newsArticleOptions){
  this._send('reqNewsArticle',requestId, providerCode, articleId, newsArticleOptions);
};

IB.prototype.reqMktDepthExchanges = function(){
  this._send('reqMktDepthExchanges');
};

IB.prototype.reqMatchingSymbols = function(requestId, pattern){
  this._send('reqMatchingSymbols', requestId, pattern);
};
